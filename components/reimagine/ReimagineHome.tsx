  ...
  return (
    <div className={`reimagine ${theme === "light" ? "is-light" : "is-dark"}`}>
      ...
      <main>
        ...
        <section className="about-v2" id="about"><div className="section-marker mono">07 / AUTHOR</div><div className="author-layout"><div className="author-photo"><img src="/assets/profile.webp" alt="Mohammad Moin" /></div><div><p className="eyebrow mono">THE PERSON BEHIND THE SYSTEM</p><h2>Technology should leave people<br />with <em>more capability.</em></h2><p>I work at the intersection of engineering, people, and practical delivery. I care about clear systems, useful abstractions, production reality, and helping teams move from knowing to doing.</p><p>The measure is simple: the solution works, the people can operate it, and the organization can keep moving.</p></div></div></section>
